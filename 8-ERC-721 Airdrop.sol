...
contract AIRDROP is ERC721Enumerable, EIP2981, Ownable {
  using Strings for uint256;
  ...
  ) EIP2981(_royaltyRecipient, _royaltyAmount) 
  ...
  function _baseURI() internal view virtual override returns (string memory) {
   ...
   function supportsInterface(bytes4 _interfaceId) public view virtual override(ERC721Enumerable, EIP2981) returns (bool) {
   ...
   function mint(address account)
        ...
        onlyOwner
    {
        ...
        require(currentSupply + 1 <= maxTotalSupply);
            _safeMint(account, currentSupply + 1);
           }
